public class Participant {
  ...
  /*
      ...
      total number of male participants -> variable name can be totalOfMaleParticipants;
      total number of female participants -> variable name can be totalOfFemaleParticipants
       */
